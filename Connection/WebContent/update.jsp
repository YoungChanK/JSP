...
<div align ="center" >
<br><br>
<form name="regFrm" method="post" action="updateProc.jsp?id=<%=id%>">
<table id = "tb1" align="center" border="0" cellSpacing ="0" cellpadding="5">
	<tr>
		<td align="center" valign="middle" bgcolor="#ffffff">
			<table id= "tb2" border="1" cellSpacing ="0" cellpadding="2" align="center" width="700">
				...
				<tr>
					...
					<td width = "60%">
						<input name ="id" placeholder="<%=id %>" size="30" readonly>
				...
				<tr>
					<td id="lasttd" colspan="3" align="center">
